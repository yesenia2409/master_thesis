...
def plot_loss_over_time():
    ...
    data = {
        ...
        '25%': [2.622, 2.624, 2.626, 2.615, 2.624, 2.625, 2.606, 2.624, 2.625, 2.599,
                2.624, 2.625, 2.589, 2.580, 2.571, 2.559, 2.547, 2.538, 2.302, 2.107],  # , 1.992], # , 1.936],
        '50%': [2.587, 2.623, 2.625, 2.526, 2.621, 2.625, 2.444, 2.619, 2.625, 2.366,
                2.615, 2.625, 2.283, 2.215, 2.147, 2.081, 2.033, 1.988, 1.573, 1.422],  # 1.376], # , 1.353],
        '75%': [2.482, 2.620, 2.624, 2.288, 2.612, 2.624, 2.096, 2.601, 2.624, 1.970,
                2.589, 2.624, 1.868, 1.790, 1.721, 1.658, 1.621, 1.572, 1.295, 1.273],  # 1.364], # , 1.706],
        '100%': [2.295, 2.612, 2.624, 1.991, 2.593, 2.624, 1.797, 2.567, 2.623, 1.657,
                 2.533, 2.622, 1.571, 1.496, 1.440, 1.383, 1.357, 1.333, 1.230, 1.250],  # 1.932] # , 9.949]
    }
    ...
    plt.ylabel('loss')
    plt.legend(loc=3, ncols=3)

    plt.show()
    # plt.savefig("loss_over_time_per_learning_rate.png")
    print("Steepest slope: ", min(slopes, key=lambda t: t[1]))
